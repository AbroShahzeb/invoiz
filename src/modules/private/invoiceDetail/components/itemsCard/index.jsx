...
export const ItemsCard = ({ invoice }) => {
  return (
    <div className="mt-[38px] rounded-lg overflow-hidden">
      <div className="p-6 bg-blue-muted-50 flex flex-col gap-6 text-heading-sm-variant font-bold">
      ...
      <div className="p-6 flex items-center gap-3 justify-between text-white bg-dark-600">
