...
export const DetailCard = ({ invoice }) => {
  ...
  return (
    <div className="mt-4 md:mt-6 bg-white rounded-[6px] md:rounded-lg shadow-invoice-card p-6">
      <div>
        <div className="text-heading-sm-variant font-bold hover:underline">
          <span className="text-blue-muted-500">#</span>
          {invoice.id}
        </div>
        <p className="mt-1 text-body-variant font-medium text-blue-muted-500">
          {invoice.description}
        </p>
      </div>

      <div className="text-body-variant font-medium text-blue-muted-500 mt-[30px]">
      ...
      <div className="flex items-start gap-10 mt-[31px]">
        <div>
          <div>
            <p className="text-body-variant font-medium text-blue-muted-500">
              Invoice Date
            </p>
