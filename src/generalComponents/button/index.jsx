import { IconArrowLeft, IconPlus } from "../../assets/svgIconComponents";
...
export const Button = ({
  ...
  const variants = {
    ...
    tertiary:
      "text-heading-sm-variant font-bold px-6 py-4 h-12 rounded-[24px] bg-blue-muted-50 dark:bg-dark-700 text-blue-muted-300 hover:bg-blue-muted-100  dark:text-blue-muted-100 dark:hover:bg-white transition-all flex items-center justify-center",
    danger:
    ...
    back: "text-heading-sm-variant font-bold   transition-all flex items-center justify-center  gap-6",
  };
